...
const COMMANDS = {
  ...
  rules: {
    ...
    body: [
      ...
      'Sonnet xhigh; omelette-reviewer: Opus xhigh; all four disallow',
      'Agent, the reviewer also Edit and NotebookEdit) into .claude/agents,',
      'where their effort is set, and the /omelette-test skill into',
