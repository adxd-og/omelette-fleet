...
test('Stop: a fence the ledger opened BEFORE the crossing is still open in the appended text — its closing fence closes it, and the heading after it is the block', () => {
  const g = guard();
